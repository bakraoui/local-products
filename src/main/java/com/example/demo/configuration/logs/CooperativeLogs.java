...
@Aspect
public class CooperativeLogs {

    Logger logger = LoggerFactory.getLogger(CooperativeLogs.class);

    @Around("execution(* com.example.demo.Controllers.CooperativeController.*(..) )")
